      ...
      <div className="min-h-screen flex justify-center bg-[url(/QP2.webp)] items-center px-4">
        ...
        >
          <div className="bg-[url(/Box1.webp)] bg-center rounded-xl  ">
            <motion.h2 initial={{opacity:0}} animate={{opacity:1}} className="font-bebas text-xl sm:text-3xl py-2 mb-4">
          ...
          >
            {maleOptions[currentQuestion].map((opt) => (
              <motion.button
                ...
                className={`w-full py-3 px-4 border text-left text-red-beech-900 font-dmSans font-bold text- border-white/30 bg-[rgba(255,255,255,0.42)] hover:bg-[rgba(255,255,255,0.20)] rounded-xl text-sm sm:text-xl ${
