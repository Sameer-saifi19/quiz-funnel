            ...
            <div id="af-form-931623795" className="af-form"><div id="af-body-931623795" className="af-body af-standards">
              <div className="af-element">
                ...
                <div className="af-textWrap">
                  <input id="awf_field-118242225" {...register('name')} placeholder='Name' type="text" name="name" className="w-full py-3 px-4 border text-left  font-dmSans font-bold text-red-beech-900 border-white/30 bg-[rgba(255,255,255,0.42)] hover:bg-[rgba(255,255,255,0.20)] rounded-xl text-sm sm:text-xl mb-4" tabIndex={500} />
                </div>
                ...
                <div className="af-textWrap">
                  <input className="w-full py-3 px-4 border text-left  font-dmSans font-bold text-red-beech-900 border-white/30 bg-[rgba(255,255,255,0.42)] hover:bg-[rgba(255,255,255,0.20)] rounded-xl text-sm sm:text-xl mb-4" id="awf_field-118242226" type="email" tabIndex={501} placeholder='Email' {...register('email')} />
